...
import com.nukkitx.protocol.bedrock.v575.serializer.CameraInstructionSerializer_v575;
import com.nukkitx.protocol.bedrock.v575.serializer.CameraPresetsSerializer_v575;
 ...
 */
@UtilityClass
public class Bedrock_v582 {
    public static final BedrockPacketCodec V582_CODEC = BedrockPacketCodec.builder()
        .raknetProtocolVersion(11)
        .protocolVersion(582)
        .minecraftVersion("1.19.80")
        .helper(BedrockPacketHelper_v582.INSTANCE)
        ...
        .registerPacket(StartGamePacket.class, StartGameSerializer_v582.INSTANCE, 11)
