...
public interface BedrockPacketHandler extends PacketHandler {
    ...
    default boolean handle(ServerPostMovePositionPacket packet) {
        return false;
    }

    default boolean handle(ToggleCrafterSlotRequestPacket packet) {
        return false;
    }

    default boolean handle(SetPlayerInventoryOptionsPacket packet) {
        return false;
    }
}
